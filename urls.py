...
urlpatterns = patterns('cochlear',
    ...
    #ajax methods
    url(r'^manager/addManager/$','views.addManager', name='addManager'),
    #url(r'^manager/addManager/(?P<newManager>([A-Z])\w+)/$','views.addManager', name='addManager'),
    url(r'^loadUserStat/$','views.loadUserStat',name = 'loadUserStat'),
    url(r'^manager/loadUserDatatable/$','views.loadUserDatatable',name = 'loadUserDatatable'),
